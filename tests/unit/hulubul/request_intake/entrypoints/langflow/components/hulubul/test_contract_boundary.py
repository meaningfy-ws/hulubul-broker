...
@pytest.fixture
def router_input_boundary() -> RouterInputBoundaryComponent:
    """Create a RouterInputBoundaryComponent."""
    return RouterInputBoundaryComponent()


@pytest.fixture
def intake_input_boundary() -> IntakeInputBoundaryComponent:
    """Create an IntakeInputBoundaryComponent."""
    return IntakeInputBoundaryComponent()


@pytest.fixture
def contract_result_boundary() -> ContractResultBoundaryComponent:
...
class TestRegistryCompleteness:
    ...
    def test_registry_contains_all_contract_kinds(
    ...
    def test_registry_has_exactly_11_entries(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
...
class TestRouterInputBoundary:
    ...
    def test_router_input_uses_fixed_edges(
        self, router_input_boundary: RouterInputBoundaryComponent
    ) -> None:
    ...
    def test_router_input_fixed_envelope_not_substitutable(
        self, router_input_boundary: RouterInputBoundaryComponent
    ) -> None:
    ...
    def test_router_input_fixed_context_not_substitutable(
        self, router_input_boundary: RouterInputBoundaryComponent
    ) -> None:
...
class TestIntakeInputBoundary:
    ...
    def test_intake_input_uses_fixed_edges(
        self, intake_input_boundary: IntakeInputBoundaryComponent
    ) -> None:
    ...
    def test_intake_input_fixed_envelope_not_substitutable(
        self, intake_input_boundary: IntakeInputBoundaryComponent
    ) -> None:
    ...
    def test_intake_input_fixed_context_not_substitutable(
        self, intake_input_boundary: IntakeInputBoundaryComponent
    ) -> None:
...
class TestCanonicalConversion:
    ...
    def test_contract_result_boundary_returns_json_or_message(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
    ...
    def test_contract_result_boundary_handles_intake_facts(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
    ...
    def test_contract_result_boundary_returns_error_for_empty(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
...
class TestErrorRedaction:
    ...
    def test_invalid_dict_returns_json(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
    ...
    def test_error_response_does_not_expose_user_values(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
        ...
        elif isinstance(output, Data | JSON):
...
class TestNoRawDictAfterValidation:
    ...
    def test_router_input_output_is_typed_message(
        self, router_input_boundary: RouterInputBoundaryComponent
    ) -> None:
    ...
    def test_intake_input_output_is_typed_message(
        self, intake_input_boundary: IntakeInputBoundaryComponent
    ) -> None:
    ...
    def test_contract_result_output_is_typed_message_or_data(
        self, contract_result_boundary: ContractResultBoundaryComponent
    ) -> None:
...
class TestWrapperEquality:
    ...
    def test_router_input_equality(self) -> None:
    ...
    def test_intake_input_equality(self) -> None:
    ...
    def test_router_input_frozen(self) -> None:
        ...
        with pytest.raises(ValidationError):
            wrapper.envelope = None  # type: ignore[assignment]

    def test_intake_input_frozen(self) -> None:
        ...
        # Attempt to modify frozen model
        with pytest.raises(ValidationError):
            wrapper.routing_context = None  # type: ignore[assignment]
...
class TestAllContractKinds:
    ...
    def test_all_contract_kinds_in_registry(self) -> None:
    ...
    def test_main_flow_input_kind_has_model(self) -> None:
    ...
    def test_router_input_kind_has_model(self) -> None:
    ...
    def test_intake_input_kind_has_model(self) -> None:
    ...
    def test_routing_context_kind_has_model(self) -> None:
    ...
    def test_router_result_kind_has_model(self) -> None:
    ...
    def test_intake_facts_kind_has_model(self) -> None:
    ...
    def test_intake_result_kind_has_model(self) -> None:
    ...
    def test_delivery_request_snapshot_kind_has_model(self) -> None:
    ...
    def test_operational_error_kind_has_model(self) -> None:
