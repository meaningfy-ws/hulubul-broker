...
class TestIntakeFactsSparseBoundaries:
    ...
    def test_human_text_accepts_1_character(self, field_name: str) -> None:
    ...
    def test_human_text_accepts_4000_characters(self, field_name: str) -> None:
    ...
    def test_human_text_rejects_4001_characters(self, field_name: str) -> None:
    ...
    def test_preferred_period_is_always_optional(self) -> None:
...
class TestIntakeFactsReceiverIdentity:
    ...
    def test_receiver_name_only_allowed(self) -> None:
    ...
    def test_receiver_stable_id_only_allowed(self) -> None:
    ...
    def test_both_receiver_fields_allowed_in_sparse_facts(self) -> None:
    ...
    def test_sparse_facts_with_no_receiver_identity(self) -> None:
...
class TestIntakeFactsSenderIdentity:
    ...
    def test_sender_display_name_optional(self) -> None:
...
class TestIntakeFactUpdates:
    ...
    def test_updates_with_at_least_one_field(self) -> None:
...
class TestCompleteIntakeFacts:
    ...
    def test_complete_facts_with_all_required_fields(self) -> None:
    ...
    def test_complete_facts_with_receiver_stable_id_instead_of_name(self) -> None:
...
class TestIntakeResultOutcome:
    ...
    def test_intake_result_requestcomplete_outcome(self) -> None:
    ...
    def test_intake_result_clarification_outcome(self) -> None:
    ...
    def test_intake_result_failure_outcome(self) -> None:
...
class TestIntakeResultMissingFields:
    ...
    def test_result_missing_fields_locked_tuple(self) -> None:
